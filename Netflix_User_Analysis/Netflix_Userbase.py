...
df = pd.read_csv("Netflix_Userbase(before_analysing).csv")
...
# count the unique values in the Subscription_Type column
print(Netflix.Subscription_Type.value_counts())
...
# # count the number of User_ID column
print(f"The number of users in the data is: {Netflix.User_ID.count()}")
...
Netflix.to_excel('Netflix_Data.xlsx', sheet_name='Data', index=False)
